CREATE OR ALTER PROCEDURE admin.sp_DataDictionary AS
BEGIN
    SELECT 
        'COLUMNAS' AS Seccion,
        TABLE_SCHEMA,
    ...
    SELECT 
        ...
        name AS Restriccion,
        definition AS Regla,
        'Valida que el valor cumpla una condición antes de insertarse.' AS Notas
...
SELECT * FROM GimnasioDB.sys.schemas
